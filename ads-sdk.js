      ...
      _getDefaultTemplate() {
        return (ad) => {
          ...
          return `${this._escapeHtml(ad.content)}<br><br>${hasLink ? 
            `<a href="${this._escapeHtml(linkUrl)}" target="_blank" rel="noopener noreferrer" data-linotype-click="true" style="color: #007bff; text-decoration: none;">${this._escapeHtml(ad.advertiser)}</a> (sponsored)` : 
